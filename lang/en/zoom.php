...
$string['muteuponentry'] = 'Mute participants upon entry';
$string['muteuponentry_help'] = 'Enable waiting room.';
$string['option_waiting_room'] = 'Enable waiting room';
$string['waitingroom'] = 'Waiting room';
$string['waitingroom_help'] = 'Enable waiting room.';
$string['option_meeting_authentication'] = 'Only authenticated users can join';
$string['meetingauthentication'] = 'Only authenticated users can join';
$string['meetingauthentication_help'] = 'Only authenticated users can join meetings.';
$string['option_authentication_option'] = 'Authentication option';
$string['option_authentication_option_help'] = 'Help text for authentication option';
$string['auth_staff_student'] = 'UC Staff & Students';
$string['auth_staff_student_domains'] = 'canterbury.ac.nz,uclive.ac.nz,pg.canterbury.ac.nz';
$string['auth_staff'] = 'UC Staff Only';
$string['auth_staff_domains'] = 'canterbury.ac.nz';
$string['authentication_domains'] = 'Authentication domains';
$string['authentication_domains_help'] = 'Help for Authentication domains';
$string['edit_authentication_domains'] = 'Edit authentication domains';
$string['edit_authentication_domains_help'] = 'Sign in to Zoom with the specified domains';
$string['option_auto_recording'] = 'Record the meeting automatically';
$string['option_auto_recording_help'] = 'Help text for Record the meeting automatically';
$string['autorecording'] = 'Record the meeting automatically';
$string['autorecording_help'] = 'Help text for Record the meeting automatically';
$string['auto_recording_local'] = 'On the local computer';
$string['auto_recording_cloud'] = 'In the cloud';
$string['auto_recording_none'] = 'No';